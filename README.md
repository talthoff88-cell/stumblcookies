[input1.html](https://github.com/user-attachments/files/24456232/input1.html)
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
  ...
  <div class="container">
    ...
    <div class="ticker">
      ...
      <p class="note">
        ...
        <em>You’ll be notified when your batch is baking 🍪</em>
      </p>
    </div>
  ...
  <script>
    ...
    joinBtn.addEventListener('click', () => {
      ...
      sendEmail(
        ...
        `You’re in the next batch – you’ll be notified when baking starts. 🍪`
      );

      // Baker notification when batch hits 50 cookies
      if (!batchNotified && currentBatchCount >= BATCH_SIZE) {
        batchNotified = true;
        alert('🎉 Batch reached 50 cookies! Sending notification to baker...');
        sendEmail(
      ...
      joinBtn.textContent = 'ADDED TO NEXT BATCH ✓';
    ...
    function resetBatch() {
      ...
      alert(`🍪 Batch complete! ${currentBatchCount} cookies baked. Notifying customers...`);
    ...
    document.addEventListener('keydown', (e) => {
      if (e.shiftKey && e.key.toLowerCase() === 'r') {
        if (resetBtn.style.display === 'none') {
          ...
          alert('🔧 Admin Reset Button Revealed');
        } else {
